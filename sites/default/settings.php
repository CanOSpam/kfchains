 ...
 * @endcode
 */
$config_directories[CONFIG_SYNC_DIRECTORY] = 'C:\config\sync';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_react_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_react_dd.inc';
}
// </DDSETTINGS>
